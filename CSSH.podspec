...
Pod::Spec.new do |s|
  ...
  s.description      = "libssh2 + OpenSSL + wolfSS"
  ...
  s.subspec 'OpenSSL' do |cs|
    cs.source_files = ['src/**/*.{c,h}','Sources/**/*.{c,h}','libssh2/**/*.{c,h}']
    cs.public_header_files = ['src/**/*.h','Sources/**/*.{h}','libssh2/include/**/*.h']
  ...
  s.subspec 'wolfSSL' do |cs|
    cs.source_files = ['src/**/dns.{c,h}','libssh2/**/*.{c,h}']
    cs.public_header_files = ['src/**/dns.h','libssh2/include/**/*.h']
    cs.vendored_frameworks = ["xcframework/wolfSSL.xcframework"]
